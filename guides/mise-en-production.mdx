...
<AccordionGroup>
  <Accordion title="Compte" icon="user-check" defaultOpen>
    ...
    - [ ] Le dossier **Compliance** est déposé si vous prévoyez plus de 200 000 FCFA de reversements par mois.
    - [ ] Le mode de règlement (manuel, T+0, T+1) est choisi dans **Gestion des comptes**.
  </Accordion>
...
| Montant minimum d'un reversement | 500 FCFA (20 000 FCFA net pour un virement bancaire) |
| Frais de reversement | 2 % mobile money · 1 500 FCFA banque |
| Plafond mensuel de reversement | 200 000 FCFA · 2 000 000 FCFA après vérification (Compliance) |
| Règlement automatique | T+0 (quotidien) ou T+1 (tous les 2 jours), heure d'Abidjan |
